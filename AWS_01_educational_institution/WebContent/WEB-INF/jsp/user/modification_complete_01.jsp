...
%>
  <jsp:include page="/WEB-INF/jsp/header/user_header.jsp"><jsp:param name="title" value="Info modification - Completion" /></jsp:include>

	  <article class="contents clearfix">
	    <div class="contents-complete">
	      <section class="sec-ttl">
	        <h2 class="sec-ttl-in">Completion - Info modification</h2>
