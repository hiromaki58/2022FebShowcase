...
%>
  <jsp:include page="/WEB-INF/jsp/header/user_header.jsp"><jsp:param name="title" value="Article duplication - Completed" /></jsp:include>
	  <article class="contents">
	    <h2 class="hidden">contents</h2>
	    <div class="contents-complete sec-ttl">
	      <section>
	        <h2 class="sec-ttl-in">Article duplication - Completed</h2>
