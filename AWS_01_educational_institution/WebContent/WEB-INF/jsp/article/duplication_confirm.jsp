...
<%
	...
	Article newArticle = (Article) session.getAttribute("duplicated_newarticle");
	
	ImgAddress imgaddr_eyecatch = new ImgAddress();
	if((ImgAddress) session.getAttribute("duplicated_eyecatch_path") != null){
	  imgaddr_eyecatch = (ImgAddress) session.getAttribute("duplicated_eyecatch_path");
	}
	
	ImgAddress imgaddr_01 = new ImgAddress();
	if((ImgAddress) session.getAttribute("duplicated_article_img_path_01") != null){
	  imgaddr_01 = (ImgAddress) session.getAttribute("duplicated_article_img_path_01");
	}
	
	ImgAddress imgaddr_02 = new ImgAddress();
	if((ImgAddress) session.getAttribute("duplicated_article_img_path_02") != null){
	  imgaddr_02 = (ImgAddress) session.getAttribute("duplicated_article_img_path_02");
	}
	
	ImgAddress imgaddr_03 = new ImgAddress();
	if((ImgAddress) session.getAttribute("duplicated_article_img_path_03") != null){
	  imgaddr_03 = (ImgAddress) session.getAttribute("duplicated_article_img_path_03");
	}
	
	ImgAddress imgaddr_04 = new ImgAddress();
	if((ImgAddress) session.getAttribute("duplicated_article_img_path_04") != null){
	  imgaddr_04 = (ImgAddress) session.getAttribute("duplicated_article_img_path_04");
	}
...
%>
  <jsp:include page="/WEB-INF/jsp/header/user_header.jsp"><jsp:param name="title" value="Article duplication - Confirmation" /></jsp:include>

		 <article class="contents">
	    <div class="sec-ttl">
	      <section>
	        <h2 class="sec-ttl-in">Article duplication - Confirmation</h2>
	        <img class="img-register-article" src="" alt="Article duplication - Confirmation">
	        <h4 class="ttl-register-article-01">Is it fine to register the article??</h4></section></div><!-- /sec-ttl -->
	    ...
	    <div class="contents-in">
	      <form class="form-admin-register-user" action="/article/register_article_01" method="post">
	        <section>
              ...
              &nbsp;&nbsp;〜　
               ...
               %>
	            ...
	            <%= closingMonth %>/
	            <%= closingDay %>
	            </span></div><!-- /area-register-article-01 --></section>
	        ...
	        <section>
	          ...
	          %>
	          </span></div><!-- /area-register-article-01 -->
	        </section>
	        <section>
	        ...
	        <section>
	          ...
	          <div class="area-register-article-03">
	            ...
	            <div class="img-preview-02"><img class="img-confirm-eyecatch" src="../showDplicatedTentativeEyecatch?imgPath=${ imgaddr_eyecatch.image}" alt="Eye-catching images - Confirmation" /></div>
	            <p class="ttl-article-01">Images</p>
	            <ul>
	              <li class="img-preview-04"><img class="img-confirm-article" src="../showDuplicatedTentativeArticleImg01?imgPath_01=${ imgaddr_01.image }" alt="Images - Confirmation" /></li>
	              <li class="img-preview-04"><img class="img-confirm-article" src="../showDuplicatedTentativeArticleImg02?imgPath_02=${ imgaddr_02.image }" alt="Images - Confirmation" /></li>
	              <li class="img-preview-04"><img class="img-confirm-article" src="../showDuplicatedTentativeArticleImg03?imgPath_03=${ imgaddr_03.image }" alt="Images - Confirmation" /></li>
	              <li class="img-preview-04"><img class="img-confirm-article" src="../showDuplicatedTentativeArticleImg04?imgPath_04=${ imgaddr_04.image }" alt="Images - Confirmation" /></li>
	            </ul>
	          </div><!-- /area-register-article-01 -->
	        </section>

	        <div class="btn-registration-user">
	          <a href="/article/duplication_03">
	            <span class="btn-registration-user-02">back</span></a>
	          <a href="/article/duplication_01?action=done">
	            <span class="btn-registration-user-01">register</span></a>
	        </div>

	      </form><!-- /form-admin-register-user --></div><!-- /contents-in -->
	  </article><!-- /contents -->
	</div><!-- /wrapper -->
