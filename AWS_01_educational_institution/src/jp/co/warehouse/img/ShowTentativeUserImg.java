...
@WebServlet("/showTentativeProfileImage")
public class ShowTentativeUserImg extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		if(imgaddr.getImgAddress().equals("")) {
			...
			InputStream is = context.getResourceAsStream("/common/img/img_nameless_user.jpg");
			...
			if(imgaddr.getImgAddress().matches(".*jpg.*")) {
				...
				//If wrong format image is tried to be registered, error message will be indicated.
					...
					ServletContext context = getServletContext();
					InputStream is = context.getResourceAsStream("/common/img/img_no_image_01.jpg");
