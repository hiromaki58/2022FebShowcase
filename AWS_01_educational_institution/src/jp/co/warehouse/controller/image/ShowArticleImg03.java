...
@WebServlet("/showArticleImg03")
public class ShowArticleImg03 extends HttpServlet{
	...
	throws ServletException, IOException {
		...
		try {
			...
			BufferedImage bimg = getImageDao.selectArticleImg03(Integer.parseInt(imgId));
			String articleImg03Extension = getImageDao.selectArticleImg03TypeById(Integer.parseInt(imgId));

			if(articleImg03Extension.equals("jpg")) {
		        //Send the image out
				try {
			...
			else if(articleImg03Extension.equals("png")) {
				//Send the image out
				try {
			...
			else if(articleImg03Extension.equals("gif")) {
				//Send the image out
				try {
