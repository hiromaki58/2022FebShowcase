 ...
 */
@WebServlet("/showTentativeMv")

public class ShowTentativeMv extends HttpServlet {

	private static final long serialVersionUID = 4200872071558332130L;
	...
	throws ServletException, IOException {
		...
		imgaddr= (ImgAddress) session.getAttribute("mainVisualPath");
