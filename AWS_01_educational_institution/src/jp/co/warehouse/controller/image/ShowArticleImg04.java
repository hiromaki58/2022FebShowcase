...
@WebServlet("/showArticleImg04")
public class ShowArticleImg04 extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		try {
			...
			BufferedImage bimg = getImageDao.selectArticleImg04(Integer.parseInt(imgId));
			String articleImg04Extension = getImageDao.selectArticleImg04TypeById(Integer.parseInt(imgId));

			if(articleImg04Extension.equals("jpg")) {
		        //Send the image out
				try {
			...
			else if(articleImg04Extension.equals("png")) {
				//Send the image out
				try {
			...
			else if(articleImg04Extension.equals("gif")) {
				//Send the image out
				try {
