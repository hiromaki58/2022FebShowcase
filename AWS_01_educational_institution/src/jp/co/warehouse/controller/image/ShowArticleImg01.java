...
@WebServlet("/showArticleImg01")
public class ShowArticleImg01 extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		try {
			...
			BufferedImage bimg = getImageDao.selectArticleImg01(Integer.parseInt(imgId));
			String articleImg01Extension = getImageDao.selectArticleImg01TypeById(Integer.parseInt(imgId));

			if(articleImg01Extension.equals("jpg")) {
		        //Send the image out
				try {
			...
			else if(articleImg01Extension.equals("png")) {
				//Send the image out
				try {
			...
			else if(articleImg01Extension.equals("gif")) {
				//Send the image out
				try {
